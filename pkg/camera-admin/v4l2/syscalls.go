...
// OpenDevice offers a simpler file-open operation than the Go API's os.OpenFile
// (the Go API's operation causes some drivers to return busy). It also applies file validation prior to opening the device.
